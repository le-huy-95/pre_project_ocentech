...
import { useUploadImageMutation } from "../../../../redux/slice/Employee"
...
const ModalInfoUser = (props: IPropCreateUser | any) => {
    const { formDataCreate, setFormDataCreate, previreImage, setPrevireImage, action, imageUpdate } = props
    // const [update] = useUploadImageMutation()
    const handleFileUpload = async (file: any) => {
        ...
        if (dataCreateImage?.status === 200) setFormDataCreate({ ...formDataCreate, image: `https://em-v2.oceantech.com.vn/em//public/image/${dataCreateImage?.data?.name}` })
